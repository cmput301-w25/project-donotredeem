...
//    @Test
//    public void testManualLogin() throws InterruptedException {
//        Thread.sleep(2000); // Ensure UI is ready
//
//        onView(withId(R.id.etUsername))
//                .perform(ViewActions.scrollTo(), ViewActions.typeText("User1"));
//
//        onView(withId(R.id.etPassword))
//                .perform(ViewActions.scrollTo(), ViewActions.typeText("Password1"));
//
//        onView(withId(R.id.btnLogin)).perform(click());
//
//        onView(withId(R.id.main_activity)).check(matches(isDisplayed()));
