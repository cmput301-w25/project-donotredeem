 ...
 */
public class MapFragment extends Fragment implements OnMapReadyCallback, FilterFragment.FilterMoodListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        filter_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                filterFragment.setTargetFragment(MapFragment.this, 0);
    ...
    private void updateMapMarkers(ArrayList<MoodEvent> moods_list, String display) {
        ...
        for (MoodEvent each_mood : moods_list) {
            ...
            lastLocation = new LatLng(each_mood.getLocation().getLatitude(), each_mood.getLocation().getLongitude());
                int imageId = MoodTypeEnum.getImageIdByMood(each_mood.getEmotionalState());
